    ...
    <section id="produk-terlaris">
        <div class="mb-5 flex items-end justify-between gap-4">
            <div>
                ...
                <p class="mt-2 text-sm text-[var(--text-secondary)]">Berdasarkan produk yang paling banyak terjual.</p>
            </div>
            <a href="{{ route('products.index', ['sort' => 'terlaris']) }}" class="btn-ghost px-0 py-0 text-sm">Lihat semua</a>
        </div>
        ...
        <div class="grid gap-4 md:grid-cols-2 xl:grid-cols-4">
            ...
            @empty
                <div class="md:col-span-2 xl:col-span-4">
                    <x-store.empty-state
                        icon="package"
                        title="Produk terlaris belum tersedia"
    ...
    <section class="mt-10">
        <div class="mb-5 flex items-end justify-between gap-4">
            <div>
                ...
                <p class="mt-2 text-sm text-[var(--text-secondary)]">Berdasarkan produk yang baru ditambahkan.</p>
            </div>
            <a href="{{ route('products.index', ['sort' => 'terbaru']) }}" class="btn-ghost px-0 py-0 text-sm">Lihat semua</a>
        </div>
    ...
    <section id="promo-diskon" class="mt-10">
        <div class="mb-5 flex items-end justify-between gap-4">
            <div>
                ...
                <p class="mt-2 text-sm text-[var(--text-secondary)]">Berdasarkan produk yang sedang diskon.</p>
            </div>
            <a href="{{ route('products.index', ['sort' => 'harga_terendah']) }}" class="btn-ghost px-0 py-0 text-sm">Lihat semua</a>
        </div>
