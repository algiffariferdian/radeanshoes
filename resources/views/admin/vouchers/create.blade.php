<x-layouts.admin :title="'Tambah Voucher - Admin RadeanShoes'">
    <div class="mx-auto max-w-4xl rounded-[1.75rem] border border-stone-200 bg-white p-6 shadow-sm">
        <div class="mb-6">
            ...
            <h1 class="mt-2 text-3xl font-black tracking-tight text-stone-950">Tambah Voucher</h1>
        </div>
        ...
        <form method="POST" action="{{ route('admin.vouchers.store') }}">
            ...
            <div class="mt-6 flex items-center justify-end gap-3">
                ...
                <button type="submit" class="rounded-full bg-stone-950 px-5 py-3 text-sm font-semibold text-stone-50">Simpan Voucher</button>
            </div>
        </form>
    </div>
</x-layouts.admin>
